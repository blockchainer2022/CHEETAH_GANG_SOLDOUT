...
const Index = () => {
  return (
    <section id="milestones" className="milestones-part py-6">
        ...
        <div className="timeline time-body">
          ...
          >
            <div className="time-content">
              ...
              <p>10% of the funds will be donated to animal welfare.</p>
            </div>
          </div>
          <div
            data-aos="fade-down"
          ...
          >
            <div className="time-content">
              ...
              <p>
                Free NFT giveaways to existing holders on upcoming collaboration
                NFT projects.
                <br />
              </p>
            </div>
          ...
          >
            <div className="time-content">
              ...
              <p>More plans will be revealed.</p>
            </div>
          </div>
        </div>
      </div>
